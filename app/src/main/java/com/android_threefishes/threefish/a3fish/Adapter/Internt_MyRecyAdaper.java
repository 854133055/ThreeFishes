...
import com.android_threefishes.threefish.a3fish.Entity.Internt_CardInfEntity;
...
public class Internt_MyRecyAdaper extends RecyclerView.Adapter<MyViewHolder> implements View.OnClickListener{

    private List<Internt_CardInfEntity> cardInfEntityList;
    private Context mContext;
    private Internt_CardInfEntity cardInfEntity;
    private int width;
    private int imageHeigh;
    private int cardViewHeigh;

    public Internt_MyRecyAdaper(List<Internt_CardInfEntity> cardInfEntityList, Context mContext) {
